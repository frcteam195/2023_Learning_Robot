...
echo_and_run cd "/mnt/working/2023_Learning_Robot/catkin_ws/src/frc_robot_utilities_py_node"
...
echo_and_run /usr/bin/env \
    ...
    "/mnt/working/2023_Learning_Robot/catkin_ws/src/frc_robot_utilities_py_node/setup.py" \
     \
    build --build-base "/mnt/working/2023_Learning_Robot/outputs/x86_64/build/frc_robot_utilities_py_node" \
    install \
    --root="${DESTDIR-/}" \
