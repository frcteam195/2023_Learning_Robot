...
echo_and_run cd "/mnt/working/2022_ROS_Swerve_Robot/catkin_ws/src/hmi_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/mnt/working/2022_ROS_Swerve_Robot/catkin_ws/src/hmi_node/setup.py" \
     \
    build --build-base "/mnt/working/2022_ROS_Swerve_Robot/outputs/x86_64/build/hmi_node" \
    install \
    --root="${DESTDIR-/}" \
