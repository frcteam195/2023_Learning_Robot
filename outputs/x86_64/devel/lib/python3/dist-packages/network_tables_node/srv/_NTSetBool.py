...
"""autogenerated by genpy from network_tables_node/NTSetBoolRequest.msg. Do not edit."""
import codecs
import sys
...
class NTSetBoolRequest(genpy.Message):
  _md5sum = "c69fa917dba768a364da909d74f4b190"
  _type = "network_tables_node/NTSetBoolRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetBoolRequest, self).__init__(*args, **kwds)
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from network_tables_node/NTSetBoolResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class NTSetBoolResponse(genpy.Message):
  _md5sum = "2b9bb09283bd6fd7d537098b659784ab"
  _type = "network_tables_node/NTSetBoolResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Outputs
bool success
time last_valid
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetBoolResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B2I():
    ...
    return _struct_B2I
class NTSetBool(object):
  _type          = 'network_tables_node/NTSetBool'
  _md5sum = '81dbfcefcb21cea79307ff5b647eb1ef'
  _request_class  = NTSetBoolRequest
  _response_class = NTSetBoolResponse
