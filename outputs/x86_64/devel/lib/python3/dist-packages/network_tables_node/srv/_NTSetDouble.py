...
"""autogenerated by genpy from network_tables_node/NTSetDoubleRequest.msg. Do not edit."""
import codecs
import sys
...
class NTSetDoubleRequest(genpy.Message):
  _md5sum = "7aebe0fa7134110eb4e7f25e4973cf31"
  _type = "network_tables_node/NTSetDoubleRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetDoubleRequest, self).__init__(*args, **kwds)
...
def _get_struct_d():
    ...
    return _struct_d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from network_tables_node/NTSetDoubleResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class NTSetDoubleResponse(genpy.Message):
  _md5sum = "2b9bb09283bd6fd7d537098b659784ab"
  _type = "network_tables_node/NTSetDoubleResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Outputs
bool success
time last_valid
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetDoubleResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B2I():
    ...
    return _struct_B2I
class NTSetDouble(object):
  _type          = 'network_tables_node/NTSetDouble'
  _md5sum = 'fb1eb722c775a2e6382a59aeda93db62'
  _request_class  = NTSetDoubleRequest
  _response_class = NTSetDoubleResponse
