...
"""autogenerated by genpy from network_tables_node/NTSetDoubleArrayRequest.msg. Do not edit."""
import codecs
import sys
...
class NTSetDoubleArrayRequest(genpy.Message):
  _md5sum = "00028d6a420ee537029cab624340f25c"
  _type = "network_tables_node/NTSetDoubleArrayRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetDoubleArrayRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from network_tables_node/NTSetDoubleArrayResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class NTSetDoubleArrayResponse(genpy.Message):
  _md5sum = "2b9bb09283bd6fd7d537098b659784ab"
  _type = "network_tables_node/NTSetDoubleArrayResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Outputs
bool success
time last_valid
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetDoubleArrayResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B2I():
    ...
    return _struct_B2I
class NTSetDoubleArray(object):
  _type          = 'network_tables_node/NTSetDoubleArray'
  _md5sum = 'afd4ce03a9cf9f79ec2a13e86db27f86'
  _request_class  = NTSetDoubleArrayRequest
  _response_class = NTSetDoubleArrayResponse
