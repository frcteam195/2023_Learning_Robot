...
"""autogenerated by genpy from network_tables_node/NTSetStringRequest.msg. Do not edit."""
import codecs
import sys
...
class NTSetStringRequest(genpy.Message):
  _md5sum = "5a7dbc7f1a6e64d71b52dc6f45d12700"
  _type = "network_tables_node/NTSetStringRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetStringRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from network_tables_node/NTSetStringResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class NTSetStringResponse(genpy.Message):
  _md5sum = "2b9bb09283bd6fd7d537098b659784ab"
  _type = "network_tables_node/NTSetStringResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Outputs
bool success
time last_valid
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NTSetStringResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B2I():
    ...
    return _struct_B2I
class NTSetString(object):
  _type          = 'network_tables_node/NTSetString'
  _md5sum = 'dc533d14351660a9df0803ae4ce0d5ae'
  _request_class  = NTSetStringRequest
  _response_class = NTSetStringResponse
