...
class NTSetStringArrayRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetStringArrayRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetStringArrayRequest
    let len;
    let data = new NTSetStringArrayRequest(null);
  ...
  static datatype() {
    ...
    return 'network_tables_node/NTSetStringArrayRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '43a0404d526292a9074df3f004194541';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetStringArrayRequest(null);
...
class NTSetStringArrayResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetStringArrayResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetStringArrayResponse
    let len;
    let data = new NTSetStringArrayResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'network_tables_node/NTSetStringArrayResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetStringArrayResponse(null);
...
module.exports = {
  Request: NTSetStringArrayRequest,
  Response: NTSetStringArrayResponse,
  md5sum() { return '4bd4089fb640c551be72d56070a4d007'; },
  datatype() { return 'network_tables_node/NTSetStringArray'; }
};
