...
class NTGetStringRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTGetStringRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTGetStringRequest
    let len;
    let data = new NTGetStringRequest(null);
  ...
  static datatype() {
    ...
    return 'network_tables_node/NTGetStringRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTGetStringRequest(null);
...
class NTGetStringResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTGetStringResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTGetStringResponse
    let len;
    let data = new NTGetStringResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTGetStringResponse(null);
...
module.exports = {
  Request: NTGetStringRequest,
  Response: NTGetStringResponse,
  md5sum() { return '5cc04fd552fedfa48e470913757b4777'; },
  datatype() { return 'network_tables_node/NTGetString'; }
};
