...
class NTSetRawRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetRawRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetRawRequest
    let len;
    let data = new NTSetRawRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetRawRequest(null);
...
class NTSetRawResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetRawResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetRawResponse
    let len;
    let data = new NTSetRawResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'network_tables_node/NTSetRawResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetRawResponse(null);
...
module.exports = {
  Request: NTSetRawRequest,
  Response: NTSetRawResponse,
  md5sum() { return 'dc533d14351660a9df0803ae4ce0d5ae'; },
  datatype() { return 'network_tables_node/NTSetRaw'; }
};
