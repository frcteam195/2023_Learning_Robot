...
class NTSetDoubleRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetDoubleRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetDoubleRequest
    let len;
    let data = new NTSetDoubleRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetDoubleRequest(null);
...
class NTSetDoubleResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NTSetDoubleResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NTSetDoubleResponse
    let len;
    let data = new NTSetDoubleResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NTSetDoubleResponse(null);
...
module.exports = {
  Request: NTSetDoubleRequest,
  Response: NTSetDoubleResponse,
  md5sum() { return 'fb1eb722c775a2e6382a59aeda93db62'; },
  datatype() { return 'network_tables_node/NTSetDouble'; }
};
